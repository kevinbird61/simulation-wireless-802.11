% Process data generated by sim2.m (different network size)
% Need to be fixed!
% Currently just copy process_sim1.m
...
for isize = 10:10:(10+10*(nsize-1))
    n = isize;
    fid = fopen([log_file, num2str(n/10)], 'r');
    ...
    fid = fopen([log_file, num2str(n/10) '_rreqrrep'], 'r');
    if fid == -1, error('Cannot open log file'); end
